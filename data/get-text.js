...
console.log("qr.canvas data=" + JSON.stringify(data));
      ...
      size *= 25;
console.log("qr.canvas size=" + size);
...
function read(a)
{
	try {
		alert(a);
		stopVideo();
		self.port.emit("text-entered", a);
		var obj = {};
		obj.text = a;
		self.postMessage(obj);
	} catch(e) {
		console.error("qrcode decode callback threw: " + e);
		alet("qrcode decode callback threw: " + e);
	}
}
...
self.port.on("show", function onShow() {
  "use strict";
  console.log("get-text.js show");
});

self.port.on("found-password-form", function(obj) {
  "use strict";
